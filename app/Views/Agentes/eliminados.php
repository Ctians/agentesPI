                  ...
                  <div class="col-12">
                      <div class="card">
                          <div class="card-header">
                              <h3 class="card-title">Agentes de la propiedad Intelectual Eliminados</h3>
                          </div>
                          <!-- /.card-header -->
                          <div class="card-body">
                                  ...
                                  <tbody>
                                      <?php foreach ($datos as $dato) : ?>
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="" data-href="<?php echo base_url(); ?>/Agentes/reingresar/<?php echo $dato['id_agentes']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Reingreso registro" class="btn btn-info"><i class="fas fa-arrow-up"></i></a>
                                              </td>
                                          </tr>
                                      <?php endforeach; ?>
                                  </tbody>

                  ...
                  <tbody>
                    <?php foreach ($datos as $dato) : ?>
                      <tr>
                        ...
                        <td><?php echo $dato['nombre1'] . " " . $dato['nombre2']; ?></td>
                        <td><?php echo $dato['apellido1'] . " " . $dato['apellido2']; ?></td>
                        <td><?php echo $dato['correo']; ?></td>
                        <td><?php echo $dato['fecha_creado']; ?></td>
                        <td>
                          <a href="<?php echo base_url(); ?>/Agentes/ver/<?php echo $dato['id_agentes']; ?>" class="btn btn-primary"><i class="nav-icon far fa-eye"></i></a>&nbsp;
                          <a href="<?php echo base_url(); ?>/Agentes/editar/<?php echo $dato['id_agentes']; ?>" class="btn btn-warning"><i class="nav-icon fas fa-pencil-alt"></i></a>&nbsp;
                          <!--<a href="" data-href="<?php echo base_url(); ?>/Agentes/eliminar/<?php echo $dato['id_agentes']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Eliminar registro" class="btn btn-danger"><i class="nav-icon fas fa-trash"></i></a>&nbsp;
                          <a href="<?php echo base_url(); ?>/Agentes/muestraPdf/<?php echo $dato['id_agentes']; ?>" class="btn btn-success"><i class="nav-icon fas fa-file-pdf"></i></a> -->
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>

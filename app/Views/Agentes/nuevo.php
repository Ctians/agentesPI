  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
          <div class="row mb-12">
              <div class="col-sm-12">
                  <form enctype="multipart/form-data" method="POST" action="<?php echo base_url() ?>/Agentes/insertar" autocomplete="off">
                      <?php csrf_field(); ?>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <select id="id_usuarios" class="form-control" name="id_usuarios">
                                              ...
                                              <?php foreach ($usuarios as $usuario) { ?>
                                                  <option value="<?php echo $usuario['id_usuarios']; ?>" <?php echo set_value('id_usuarios') == $usuario['id_usuarios'] ? 'selected' : '' ?>><?php echo $usuario['correo']; ?></option>
                                              <?php } ?>
                                              
                                          </select>
                                          <div style="color: red;">
                                              <?= $error = $validation->getError('id_usuarios'); ?>
                                          </div>
                                      </div>
                                      <div class="col-12 col-sm-6">

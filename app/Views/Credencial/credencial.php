          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Credencial Agentes de la propiedad Intelectual</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    <?php foreach ($datos as $dato) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url(); ?>/Credencial/muestraPdf/<?php echo $dato['id_agentes']; ?>" class="btn btn-success"><i class="nav-icon fas fa-file-pdf"></i></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>

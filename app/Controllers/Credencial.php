...
class Credencial extends BaseController
{
    ...
    public function index($id_permiso = 3)
    {
        ...
        $acceso = $this->detalles_roles_accesos->verificaAccesos($this->session->id_rol, 'CredencialMostrar');
        ...
        echo view('Template/header');
        echo view('Template/main');
        echo view('Credencial/credencial', $data);
        echo view('Template/footer');
    }
    ...
    public function muestraPdf($id_agentes)
    {
        ...
        $acceso = $this->detalles_roles_accesos->verificaAccesos($this->session->id_rol, 'CredencialPDF');
        ...
        echo view('Template/header');
        echo view('Template/main');
        echo view('Credencial/ver_pdf', $data);
        echo view('Template/footer');
    }
